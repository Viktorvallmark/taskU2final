...
public class MainPanel extends JPanel {
  ...
  private void setupPanel() {
    ...
    pnlCenter = new CenterPanelGuestInput(
        controller, 4 * width / 10, 8 * height / 10, 6); // labels and textboxes
    ...
    pnlEast =
        new EastPanelGuestList(controller, 6 * width / 10, 8 * height / 10, 6);
    add(pnlCenter, BorderLayout.CENTER);

    add(pnlEast, BorderLayout.EAST);
  }

  public CenterPanelGuestInput getPnlCenter() { return pnlCenter; }

  public SouthPanelButtons getPnlSouth() { return pnlSouth; }
