...
public class MainFrame extends JFrame {
  ...
  public String getAgeText() { return mainPanel.getPnlCenter().getAgeText(); }

  public void setAgeText(String str) {
    mainPanel.getPnlCenter().setAgeText(str);
  }
  ...
  public String getCityText() { return mainPanel.getPnlCenter().getCityText(); }
  ...
  public int getListIndex() { return mainPanel.getPnlEast().getListIndex(); }
}
